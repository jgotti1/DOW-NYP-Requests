  ...
  try {
    ...
    try {
      ...
      if (req.params.id) {
        ...
        const result = await client.query("SELECT * FROM dow_requests WHERE id = $1", [requestId]);
        ...
        // Retrieve all dow_requests
         const result = await client.query("SELECT * FROM dow_requests ORDER BY request_needed_date ASC");
