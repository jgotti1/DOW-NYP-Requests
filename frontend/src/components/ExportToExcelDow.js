...
const ExportToExcelDow = ({ data }) => {
  const handleExportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "DowJones-Requests");

    const formattedDate = formatDate(new Date());
    const filename = `DowPrequests-${formattedDate}.xlsx`;
...
export default ExportToExcelDow;
